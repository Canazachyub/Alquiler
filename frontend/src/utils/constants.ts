...
export const API_URL = import.meta.env.VITE_API_URL || 'https://script.google.com/macros/s/AKfycbzHbQF_PGclbINecDWJgA9JAAqMMvMvdtTdKveAClCU4ZW3Xt8g3tzfMqgepnuOZuCs/exec';
